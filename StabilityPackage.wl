...
foc1234[x_,y_,z_,E_]:= ((3c^3)/(4 Pi h (1/2 (data["freqs"][[E+1]]+data["freqs"][[E]])) (data["freqs"][[E+1]]^3 3-data["freqs"][[E]]^3)) )
(datasr["Endensity"][[species,E,1]] + 3 z datasr["Endensity"][[species,E,2]]
